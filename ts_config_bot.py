...
reward_channels_ids = [vote-serveur]  # Canaux dans lequel on peut exécuter la commande
reward_necessary_roles_ids = [Joueur]  # Rôles nécessaires pour exécuter la commande
reward_amount = '500'  # Total d'argent donné pour la récompense

# Top Serveur
ts_server_token = 'ZXCF4B6K7Z'  # Identifiant API du serveur sur Top Serveur
